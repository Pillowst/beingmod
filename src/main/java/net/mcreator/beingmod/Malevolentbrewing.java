 ...
 * are overrides of the base class BeingmodModElements.ModElement.
 *
 ...
 * outside net.mcreator.beingmod as this package is managed by MCreator.
 *
 * If you change workspace package, modid or prefix, you will need
 * to manually adapt this file to these changes or remake it.
*/
package net.mcreator.beingmod;
...
public class Malevolentbrewing extends BeingmodModElements.ModElement {
	/**
	 * Do not remove this constructor
	 */
	public Malevolentbrewing(BeingmodModElements instance) {
		super(instance, 42);
	}
