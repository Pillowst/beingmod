...
public class BeingdiamondBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:beingdiamond")
	public static final Block block = null;
	public BeingdiamondBlock(BeingmodModElements instance) {
		super(instance, 64);
	}
