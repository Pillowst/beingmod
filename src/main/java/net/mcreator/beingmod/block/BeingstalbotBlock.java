...
public class BeingstalbotBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:beingstalbot")
	public static final Block block = null;
	public BeingstalbotBlock(BeingmodModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(3f, 3f).lightValue(0).notSolid()
					.tickRandomly());
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BeingstalbotBlock.block, (int) (0)));
		}
