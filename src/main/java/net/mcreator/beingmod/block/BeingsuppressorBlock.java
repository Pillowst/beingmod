...
import net.mcreator.beingmod.procedures.BeingsuppressorUpdateTickProcedure;
...
public class BeingsuppressorBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:beingsuppressor")
	public static final Block block = null;
	@ObjectHolder("beingmod:beingsuppressor")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BeingsuppressorBlock(BeingmodModElements instance) {
		super(instance, 81);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("beingsuppressor"));
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("beingsuppressor");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				BeingsuppressorUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("beingsuppressor");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Being suppressor");
		}
