...
public class DessicatedstalkBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:dessicatedstalk")
	public static final Block block = null;
	public DessicatedstalkBlock(BeingmodModElements instance) {
		super(instance, 79);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		FlowersFeature feature = new DefaultFlowersFeature(BlockClusterFeatureConfig::deserialize) {
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
				...
				int y = pos.getY();
				int z = pos.getZ();
				if (!DessicatedstalkAdditionalGenerationConditionProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
					return false;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("dessicatedstalk");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.STICK, (int) (2)));
		}
