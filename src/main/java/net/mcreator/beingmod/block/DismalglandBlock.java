...
public class DismalglandBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:dismalgland")
	public static final Block block = null;
	public DismalglandBlock(BeingmodModElements instance) {
		super(instance, 31);
	}
