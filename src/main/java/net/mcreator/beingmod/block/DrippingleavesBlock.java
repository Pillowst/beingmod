...
public class DrippingleavesBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:drippingleaves")
	public static final Block block = null;
	public DrippingleavesBlock(BeingmodModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("drippingleaves");
		}
