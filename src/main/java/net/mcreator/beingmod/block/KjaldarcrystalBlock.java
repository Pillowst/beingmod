...
public class KjaldarcrystalBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:kjaldarcrystal")
	public static final Block block = null;
	public KjaldarcrystalBlock(BeingmodModElements instance) {
		super(instance, 121);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		FlowersFeature feature = new DefaultFlowersFeature(BlockClusterFeatureConfig::deserialize) {
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
				...
				int y = pos.getY();
				int z = pos.getZ();
				if (!KjaldarcrystalAdditionalGenerationConditionProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
					return false;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("kjaldarcrystal");
		}
