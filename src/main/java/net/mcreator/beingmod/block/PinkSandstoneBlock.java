...
import net.mcreator.beingmod.procedures.PinkSandstoneRedstoneOnProcedure;
...
public class PinkSandstoneBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:pink_sandstone")
	public static final Block block = null;
	public PinkSandstoneBlock(BeingmodModElements instance) {
		super(instance, 189);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("pink_sandstone", "pink_sandstone", blockAt -> {
