...
public class PolishedMarbleBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:polished_marble")
	public static final Block block = null;
	public PolishedMarbleBlock(BeingmodModElements instance) {
		super(instance, 186);
	}
