...
public class PrecursorspikesanalogBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:precursorspikesanalog")
	public static final Block block = null;
	public PrecursorspikesanalogBlock(BeingmodModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("precursorspikesanalog");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(PrecursorspikesbotanalogBlock.block, (int) (1));
		}
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				PrecursorspikestopEntityCollidesInTheBlockProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
