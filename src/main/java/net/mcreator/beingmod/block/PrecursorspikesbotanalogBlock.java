...
public class PrecursorspikesbotanalogBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:precursorspikesbotanalog")
	public static final Block block = null;
	public PrecursorspikesbotanalogBlock(BeingmodModElements instance) {
		super(instance, 170);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("precursorspikesbotanalog");
		}
