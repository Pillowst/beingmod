...
public class PrecursorspikestopBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:precursorspikestop")
	public static final Block block = null;
	public PrecursorspikestopBlock(BeingmodModElements instance) {
		super(instance, 161);
	}
