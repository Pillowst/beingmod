...
public class PrecursorwallBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:precursorwall")
	public static final Block block = null;
	public PrecursorwallBlock(BeingmodModElements instance) {
		super(instance, 134);
	}
