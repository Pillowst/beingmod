...
import net.mcreator.beingmod.procedures.QuantumReactorBlockUpdateTickProcedure;
...
public class QuantumReactorBlockBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:quantum_reactor_block")
	public static final Block block = null;
	public QuantumReactorBlockBlock(BeingmodModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				QuantumReactorBlockUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	}
