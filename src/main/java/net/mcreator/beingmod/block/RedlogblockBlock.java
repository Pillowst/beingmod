...
public class RedlogblockBlock extends BeingmodModElements.ModElement {

	@ObjectHolder("beingmod:redlogblock")
	public static final Block block = null;

	public RedlogblockBlock(BeingmodModElements instance) {
		super(instance, 216);
