...
public class WarmedfolliclesBlock extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:warmedfollicles")
	public static final Block block = null;
	public WarmedfolliclesBlock(BeingmodModElements instance) {
		super(instance, 40);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("warmedfollicles");
		}
