...
public class DiamondboltItem extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:diamondbolt")
	public static final Item block = null;
	public DiamondboltItem(BeingmodModElements instance) {
		super(instance, 120);
	}
