...
public class NeriumItem extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:nerium")
	public static final Item block = null;
	public NeriumItem(BeingmodModElements instance) {
		super(instance, 82);
	}
