...
package net.mcreator.beingmod.world.dimension;
...
import net.mcreator.beingmod.block.SlateBlock;
...
public class OthersideDimension extends BeingmodModElements.ModElement {
	@ObjectHolder("beingmod:otherside")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public OthersideDimension(BeingmodModElements instance) {
		super(instance, 179);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("otherside"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("beingmod:otherside")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("beingmod:otherside"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("beingmod:otherside"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("beingmod:beingplains")),
				ForgeRegistries.BIOMES.getValue(new ResourceLocation("beingmod:collapsedesseforest")),};
	}
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new OverworldGenSettings() {
				public BlockState getDefaultBlock() {
					return SlateBlock.block.getDefaultState();
				}
			...
			if (!biomesPatched) {
				for (Biome biome : this.biomes) {
					biome.addCarver(GenerationStage.Carving.AIR, Biome.createCarver(new CaveWorldCarver(ProbabilityConfig::deserialize, 256) {
						{
							carvableBlocks = ImmutableSet.of(SlateBlock.block.getDefaultState().getBlock(),
